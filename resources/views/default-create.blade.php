                ...
                <div class="left_col scroll-view">
                    ...
                    <div class="profile clearfix">
                        <div class="profile_pic">
                            <a href="../my-account"><img src="{{('../public/img.png')}}" alt="..."
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            <ul class="nav side-menu">
                                ...
                                <li><a href="../cate-product"><i class="fa fa-tasks"></i> Nhóm Lộ trình </a></li>
                         
                                <li><a href="../choose"><i class="fa fa-file-text-o"></i> Lộ trình đã chọn </a></li>
                                <li><a href="../delivery"><i class="fa fa-car"></i> Vận chuyển </a></li>
